...
<head>
    <title><?php echo $articleinfos['title']; ?></title>
...
<body>
    <?php include("menu.php");  $details=detailpost($articleinfos['id'],'ar'); addvisite('oneart'); ?>
    <div id="content" class="slideout-panel slideout-panel-right">
        ...
        <div class="app-body">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        <div id="article-author" class="content-side">
                            <div class="details">
                                <div class="article-trending box">
                                    ...
                                    <div class="box-body">
                                    <?php 
                                        $stmtA = $conn->prepare("SELECT * FROM article WHERE idU=? LIMIT 5");
                                        $stmtA->bind_param("s", $articleinfos['idU']);
                                        $stmtA->execute();
                                        $resultA=$stmtA->get_result();
                    ...
                    <div class="col-lg-8 article-box">

                        <div id="article" class="box">
                            <div class="box-header">
                                <h1><a href="#"><?php echo $articleinfos['title'] ?></a></h1>
                                <div style="right:96%" class="box-tool">
                                    <div class="mdl-dropdown">
                                        <?php if((isset($_SESSION['id']) && $_SESSION['id']==$articleinfos['idU']) || $_SESSION['type']=='1'){ ?>
                                        
                                            <a onclick="opertion(`deleteart`,`<?php echo $articleinfos['id'] ?>`)" class="btn-menu" data-id="4421" data-type="article"><span><i class="far fa-times"></i></span></a>
                                        
                                        <?php }else{ ?>
                                        
                                            <a <?php if($details['myRe']=='true'){echo 'style="color:red"';}else{} ?> id="dls<?php echo $articleinfos['id'] ?>" onclick="opertion(`ar|report`,`<?php echo $articleinfos['id'] ?>`)" class="btn-menu" data-id="4421" data-type="article"><span><i class="far fa-flag"></i></span></a>
                            ...
                            <div class="box-body">
                                <div>
                                    نشر من قبل <a class="text-primary" href="profile.php?id=<?php echo $articleinfos['idU'] ?>"> <?php echo userinfo($articleinfos['idU'])['username']; ?> </a><span>, <script type="application/javascript">
                                            moment.locale("ar_AL");
                                            document.write(moment('<?php echo $articleinfos['wn'] ?>', "YYYY-MM-DD hh:mm:ss").format('LL'));

                                        </script></span>
                                    <div class="pull-left">

                                        <span class="m-r jbtn-like" data-stats="article:4421" data-id="4421" data-type="article">

                                            <span id="likedivar<?php echo $articleinfos['id']; ?>" onclick="opertion('ar|like','<?php echo $articleinfos['id']; ?>')" class="like-cntb"><b id="likenumar<?php echo $articleinfos['id']; ?>"><?php echo $details['postL'] ?></b></span>

                                        </span>

                                        <a href="#comments" data-id="4421" style="margin-left: 4px">
                                            <i class="far fa-comments-alt"></i>
                                            <span class="total-comments"><?php echo $details['postC'] ?></span>
                                        </a>
                                    </div>
                                </div>
                                <div class="bb_text html_content_block">
                                    <?php echo $articleinfos['body']; ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div id="cmtsapp" pid="232" ptype="actor" title="" class="box comments-box post-comments" style="min-height: 100px;">
                                ...
                                <div class="post-form-body">
                                    ...
                                    <div class="post-form-textarea">
                                        ...
                                        <div class="text-left post-form-footer">
                                            ...
                                            <button id="sendc" onclick="opertion('ar|comment','<?php echo $articleinfos['id']; ?>')" type="button" class="el-button btn white m-l-sm el-button--default el-button--mini">
                                                <!---->
                                                <!----><span>نشر</span></button>

                                            <button style="display:none" id="cancel_e" onclick="cancel_e('ar|comment','<?php echo $articleinfos['id']; ?>')" type="button" class="el-button btn white m-l-sm el-button--danger el-button--mini pull-right">
                                                <!---->
                            ...
                            <div class="box-body thread-post-form">
                                <ul id="comment-top" class="post-list">
                                    ...
                                    WHERE comments.idP=? AND comments.postT='ar' AND reports.idT='cm'  AND likes.postT='cm' GROUP BY comments.id ORDER BY comments.wn DESC 
                                    ...
                                    $stmtn->bind_param("s", $articleinfos['id']);
                                    $stmtn->execute();
                                            ...
                                            <ul class="post-tooltip post-menu hidden-xs-down">
                                                ...
                                                <li class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-scale pull-right">
                                                        ...
                                                        <a class="dropdown-item story-share" onclick="upd_c('<?php echo $comminfo['postTc'] ?>','<?php echo $comminfo['id'] ?>','<?php echo $articleinfos['id'] ?>','<?php echo $comminfo['spoiler'] ?>')">تعديل</a>
                                            ...
                                            <div class="post-body">
                                                <div class="post-header p-b-xs"><a href="profile.php?id=<?php echo $comminfo['code']; ?>" target="_blank" class="user-display text-primary in-link"><b><?php echo $comminfo['username']; ?></b></a> <span class="mdl-utag"><span class="mdl-btag">
                                                        ...
                                                        <script type="application/javascript">
                                                            moment.locale("ar_AL");
                                                            document.write(moment('<?php echo $comminfo['wn'] ?>', "YYYY-MM-DD hh:mm:ss").tz('Africa/Casablanca').format('LL'));
                                                ...
                                                ?>
                                                    ...
                                                    <div class="post-body">
                                                        <div class="post-header p-b-xs"><a href="profile.php?id=<?php echo $repinfo['code']; ?>" target="_blank" class="user-display text-primary in-link"><b><?php echo $repinfo['username']; ?></b></a> <span class="mdl-utag"><span class="mdl-btag">
                                                                ...
                                                                <script type="application/javascript">
                                                                    moment.locale("ar_AL");
                                                                    document.write(moment('<?php echo $repinfo['wn'] ?>', "YYYY-MM-DD hh:mm:ss").tz('Africa/Casablanca').format('LL'));
                            ...
                            <div class="box-footer"><button id="more_cB" onclick="opertion('ar|more_c','<?php echo $articleinfos['id']; ?>')" type="button" class="el-button btn btn-block btn-default el-button--default"><span><strong id="more_cS">المزيد من التعليقات</strong></span></button></div>
                            <?php } ?>
            ...
            <script type="text/javascript" src="/dist/en/js/article.js?v=5.4.6a"></script>
