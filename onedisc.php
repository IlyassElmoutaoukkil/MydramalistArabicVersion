...
<head>
    ...
    <script type="text/javascript" src="dist/en/js/forum.js"></script>
    ...
    <link href="css/editor/mdl-theme.css?v=5.4.6" rel="stylesheet" type="text/css">
    <link href="css/editor.css?v=5.4.6" rel="stylesheet" type="text/css">
                ...
                <div class="app-body">
                    <div class="spnsr-wrapper-2007">
                        <div class="spnsr-top-2007 is-desktop">
                            <div class="mdl-gpt-tag" id="mdl-gpt-header-0" data-google-query-id="CIbO_9DCzecCFcvR1QodXaoBeA">
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-4">
                                <div class="discussions_trending">
                                    <div class="box">
                                        ...
                                        <ul class="list">
                                            <li class="list-item">
                                                <div class="list-body"><a style="margin-right: 16px;" class="text-ellipsis text-primary" href="/discussions/forum-games/44369-10-dramas-movies-with-2">ماهي أفضل دراما بالنسبة لك؟</a>
                                                    <div><small class="text-muted"><i class="fa fa-fw fa-clock-o"></i> قبل 10 دقائق </small></div>
                                                </div>
                                            </li>
                                            <li class="list-item">
                                                <div class="list-body"><a style="margin-right: 16px;" class="text-ellipsis text-primary" href="/discussions/forum-games/44369-10-dramas-movies-with-2">ماهي أفضل دراما بالنسبة لك؟</a>
                                    ...
                                    <div id="sticky-wrapper" class="sticky-wrapper" style="height: 250px;">
                                        <div class="sticky" style="width: 334px;">
                                            <div class="spnsr_right_2007">
                                                <div class="spnsr" id="mdl-gpt-fbox3-0" style="width:300px;" data-google-query-id="CPGx_tDCzecCFcvR1QodXaoBeA">
                                                    <script>
                            ...
                            <div class="col-lg-8 col-md-8">
                                ...
                                <div class="discussion-header">
                                    <h1><a href="/discussions/general-discussion/253-what-country-are-you-from">من اي بلد انت؟</a></h1>

                                    <div class="options-menu">
                                        <i class="notify-status active" data-id="253" title="You are subscribed to this topic."></i>
                                        <div class="mdl-dropdown">
                                            <a class="nav-link btn-menu" data-id="253" data-type="topic"><span><i class="far fa-chevron-down"></i></span></a>
                                        </div>
                                    </div>
                                ...
                                <div class="thead-container-top row">
                                    <div class="col-xs-3 col-sm-offset-1">
                                        <button class="btn btn-quick-reply white">إجابة
                                        </button>
                                    </div>
                                    <div class="col-xs-9 col-sm-8 col-md-8 text-right">
                                        <ul class="pagination">
                                            <li class="page-item first">
                                                <a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=1"></a>
                                            </li>
                                            <li class="page-item prev">
                                                <a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=112"></a>
                                            </li>
                                            <li class="page-item"><a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=110">110</a></li>
                                            <li class="page-item"><a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=111">111</a></li>
                                            <li class="page-item"><a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=112">112</a></li>
                                            <li class="page-item nb active"><a class="page-link" href="">113</a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div id="discuss-253" data-topic="253" class="post-container">
                                    <div class="post-listing">
                                        

                                        <div id="post-1008241" class="row post ">
                                                ...
                                                <div class="box post-box">
                                                    ...
                                                    <div class="box-header">
                                                        <div class="post__username">
                                                            <a class="text-primary" href="/profile/7756643">جميلة </a>
                                                            <span class="mdl-btag">
</span>
                                                        </div>
                                                        <div class="box-tool"><a href="/discussions/general-discussion/253-what-country-are-you-from?pid=1008241&amp;page=113#p1008241" class="timeago permalink">قبل 20 يوم</a></div>
                                                    </div>
                                                    ...
                                                    <div class="box-footer text-right">
                                                        <div class="post__actions dropdown">
                                                            <a href="#" class="btn-quote" data-data="{&quot;permlink&quot;:&quot;/general-discussion/253-what-country-are-you-from/1008241&quot;,&quot;post&quot;:&quot;1008241&quot;,&quot;topic&quot;:&quot;253&quot;,&quot;username&quot;:&quot;7756643&quot;,&quot;avatar&quot;:&quot;https://i.mydramalist.com/68reOt.jpg&quot;,&quot;display_name&quot;:&quot;horror one&quot;}"><i class="fa fa-quote-left"></i> إقتباس</a>
                                                            <a href="/profile/7756643" title="My Profile"><i class="fa fa-user"></i></a>
                                                            <a href="/dramalist/7756643" title="MyDramaList"><i class="fa fa-book"></i></a>
                                                            <div class="mdl-dropdown">
                                                                <a class="nav-link btn-menu" data-id="1008241" data-type="discusspost"><span><i class="far fa-chevron-down"></i></span></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-sm-1 hidden-xs-down">
                                                <a class="w-48 avatar" href="/profile/7756643"><img src="https://i.mydramalist.com/68reOt.jpg"></a>
                                            </div>
                                        </div>
                                ...
                                <div class="thead-container-bottom row">
                                    ...
                                    <div class="col-xs-9 col-sm-8 col-md-8 text-right">
                                        <ul class="pagination">
                                            ...
                                            <li class="page-item"><a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=110">1</a></li>
                                            <li class="page-item"><a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=111">2</a></li>
                                            <li class="page-item"><a class="page-link" href="/discussions/general-discussion/253-what-country-are-you-from?page=112">3</a></li>
                                            <li class="page-item nb active"><a class="page-link" href="">4</a></li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <div id="qr-container">
                                        <div class="row">
                                            ...
                                            <div class="col-md-11">
                                                <div class="box">
                                                    <script type="text/javascript">
                                                        var editor = new FroalaEditor('.disucssion-editor')
                                                    </script>
                                                    <div class="disucssion-editor">
                                                        <textarea rows="5" class="form-control form-quick-reply" id="editor" name="message" placeholder="Leave a comment"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group text-right">
                                                    <button type="button" class="el-button btn btn-submit-reply el-button--primary">
                                                        <!---->
                                                        <!----><span>رد</span></button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-1">
                                                <a name="quick-reply" class="w-48 avatar"><img src="https://i.mydramalist.com/letter/ilyasselmoutaoukkil" class="current-avatar"></a>
                                            </div>
                    ...
                    <script type="text/javascript" src="/dist/en/js/forum.js?v=5.4.6a"></script>
                    <div id="q1">&nbsp;</div>
                    <div id="q2">&nbsp;</div>
