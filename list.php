...
if(isset($_GET['id'])){
    ...
    if(is_numeric($_GET['id'])){                 
        $stmtA = $conn->prepare("SELECT list.id,list.idU,list.type,list.content,list.title,list.descr,list.score,list.wn,listt.id as s,listt.idL,listt.idT,listt.comment,listt.score,SUM(listt.score) as totalS,listt.wn   FROM list JOIN listt on listt.idL=list.id WHERE list.id=?");
        $stmtA->bind_param("s", $_GET['id']);
        $stmtA->execute();
        $array=[];
        $resultA=$stmtA->get_result();
        $array=$resultA->fetch_assoc();
        if($resultA->num_rows=='0'){
            $list=false;
        }else{
            if( $array['type']=='public' || $array['type']=='vote'  || ($login && $array['idU']==$_SESSION['id'] ) ){
                $list=true;
        ...
        <div class="app-body">
            <div class="spnsr-wrapper-2016">
                <div class="spnsr-top-2016 is-desktop">
                    <div class="mdl-gpt-tag" id="mdl-gpt-header-0" data-google-query-id="CKvynNav7ugCFcqeGwodxCQPjg">
                        <script>
    ...
    $url.= $_SERVER['REQUEST_URI'];    
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <div id="collection-lists" class="content-main">
                            <div class="box">
                                <div class="box-header m-t-sm">
                                    <h1 class="text-xl"><?php echo $array['title']; ?></h1>
                                    <div><?php $usri;$usri=userinfo($array['idU']); ?>
                                        <div class="list-author"><?php echo $array['wn'] ?>
                                            <div class="list-by"> <img class="w-42 avatar" src="process/<?php echo $usri['picture'] ?>">
                                                <div class="last-updated"> <a class="text-primary" href="profile.php?id=<?php echo $array['idU'] ?>"><?php echo $usri['username'] ?></a> <small>
                                                        <script type="application/javascript">
                                                            moment.locale("ar_AL");
                                                            document.write(moment('<?php echo $array['wn'] ?>', "YYYY-MM-DD hh:mm:ss").tz('Africa/Casablanca').fromNow());
                                        ...
                                        <div class="pull-left share-container text-center">
                                            
                                            <a rel="nofollow" href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $url; ?>" class="btn btn-icon btn-social rounded light"><i class="fab fa-facebook-f"></i><i class="fab fa-facebook-f indigo"></i></a>
                                            
                                            <a rel="nofollow" href="http://twitter.com/home?status=<?php echo $array['title']; ?> <?php echo $url; ?>" class="btn btn-icon btn-social rounded light"><i class="fab fa-twitter"></i><i class="fab fa-twitter light-blue"></i></a> 
                                            
                                            <a rel="nofollow" href="http://pinterest.com/pin/create/button/?url=<?php echo $url; ?>;description=<?php echo $array['title']; ?>" class="btn btn-icon btn-social rounded light"><i class="fab fa-pinterest"></i><i class="fab fa-pinterest red"></i></a>
                                            
                                            <a rel="nofollow" href="#comments" class="btn btn-icon btn-social rounded light"><i class="fa fa-comments"></i><i class="fa fa-comments green"></i></a> 
                                            
                                            <a id="likedivls<?php echo $array['id']; ?>2" onclick="opertion('ls|like','<?php echo $array['id']; ?>')" class="jbtn-like btn btn-social btn-icon rounded light <?php if(detailpost($array['id'],'ls')['myL']=='true'){ ?>active<?php }else{  } ?>" data-stats="clist:258803" data-id="W3rPWVv1" data-type="clist"><i class="far fa-heart"></i><i class="far fa-heart red"></i></a> </div>

                                    </div>
                                </div>
                                <div class="box-body" style="padding: 1.1rem 1rem;">
                                    <?php 
          
                                        $stmtA = $conn->prepare("SELECT * FROM listt WHERE idL=? ORDER BY score DESC");
                                        $stmtA->bind_param("s", $_GET['id']);
                                        $stmtA->execute();
                                        $resultA=$stmtA->get_result();
                                    ...
                                    <div class="list-bars p-y-sm m-b text-black-lt">
                                        <span style="margin-left:10px" class="m-r"><i class="far fa-user m-r-xs"></i> <?php echo $num; ?> <?php echo $typeA; ?></span>
                                        
                                        <span style="margin-left:10px" id="likedivls<?php echo $array['id']; ?>" onclick="opertion('ls|like','<?php echo $array['id']; ?>')" class="m-r jbtn-like <?php if(detailpost($array['id'],'ls')['myL']=='true'){ ?>active<?php }else{  } ?>" data-id="W3rPWVv1" data-stats="clist:258803" data-type="clist">
                                        
                                        
                                        <span style="margin-left:10px" id="likenumls<?php echo $array['id']; ?>" class="like-cntb-nohl"><?php  echo detailpost($array['id'],'ls')['postL']; ?></span> </span>
                                        <?php if($array['type']=='vote'){ ?>
                                        <span style="margin-left:10px" class="m-r"> <?php echo $array['totalS'] ?> <i class="far fa-vote-yea m-r-xs"></i> </span>
                                        <?php } ?>
                                        
                                        <?php if((isset($_SESSION['id']) && $_SESSION['id']==$array['idU']) || $_SESSION['type']=='1'){ ?>
                                        
                                            <a  onclick="opertion(`deletels`,`<?php echo $array['id'] ?>`)" class="m-r bar-item report-link" data-type="clist" rel="nofollow"><i class="icon far fa-times m-r-xs"></i> </a>
                                        
                                        <?php }else{ ?>
                                        
                                            <a <?php if(detailpost($array['id'],'ls')['myRe']=='true'){ ?> style="color:red"<?php }else{  } ?> id="dls<?php echo $array['id'] ?>" onclick="opertion(`ls|report`,`<?php echo $array['id'] ?>`)" class="m-r bar-item report-link" data-type="clist" rel="nofollow"><i class="icon far fa-flag m-r-xs"></i> </a>
                                        
                                        <?php } ?>
                                    
                                    </div>
                                    <div class="collection-list">
                                        <div class="list-header row no-gutter m-b-sm">
                                            <div class="col-xs-7"></div>
                                            <div class="col-xs-5"></div>
                                        </div>
                                        <ul class="list-group">

                                            <?php $x=0; while($cont=$resultA->fetch_assoc()){ $x++;?>
                                                
                                            <?php if($type=='persone'){ $presi; $presi=personeinfo($cont['idT']); ?>
                                                <li id="mdl-<?php echo $presi['id']; ?>" class="list-group-item">
                                                    <div class="row">
                                                        <div class="col-xs-2" style="float:right"> <a class="film-cover cover" href="persone.php?id=<?php echo $presi['id'] ?>"><img  style="height:120px"  class="img-responsive cover" src="process/<?php echo $presi['picture'] ?>" alt="<?php echo $presi['fname'].' '.$presi['lname']; ?>"></a> </div>
                                                        <div class="col-xs-10 content">
                                                            <h6 class="text-primary title"><?php echo $x; ?>. <a href="persone.php?id=<?php echo $presi['id'] ?>"><?php echo $presi['fname'].' '.$presi['lname']; ?></a></h6>
                                                            
                                                            <?php
                                                            if($presi['sex']=='1' ){
                                                                $stat= 'فنانة '.datasignif($presi['country'],'countryF');
                                                            }else{
                                                                $stat= 'فنان '.datasignif($presi['country'],'countryM'); 
                                                            }   
                                                            ?>
                                                            <div class="text-muted m-b-xs"><?php echo $stat; ?></div>
                                                            <div class="m-t"><?php if($login && $array['type']=='vote'){ ?>
                                                            
                                                                <?php 
                                                                $stmtn = $conn->prepare("SELECT * FROM votel WHERE idL=? AND idT=? AND idU=? ");
                                                                $stmtn->bind_param("sss", $array['id'], $cont['idT'], $_SESSION['id']);
                                                                $stmtn->execute();
                                                                $fs=$stmtn->get_result();
                                
                                                                if($fs->num_rows=='0'){
                                                                ?>
                                                                <button onclick="votelist('<?php echo $presi['id'] ?>','<?php echo $array['id'] ?>','ac')" class="btn btn-cast-vote btn-default btn-sm" id="vote<?php echo $presi['id'] ?>" data-id="16051">إضافة صوت</button>
                                                                <?php }else{ ?>
                                                                <button id="vote<?php echo $presi['id'] ?>" style="border:1px solid #d21818" onclick="votelist('<?php echo $presi['id'] ?>','<?php echo $array['id'] ?>','ac')" class="btn btn-cast-vote btn-default btn-sm" id="vote<?php echo $presi['id'] ?>" data-id="16051">الغاء الصوت</button>
                                                                <?php } ?>
                                                                
                                                                <span class="p-l-sm text-muted text-xs"><b id="votes<?php echo $presi['id'] ?>"><?php echo $cont['score'] ?></b> نقطة</span>
                                                            
                                                            <?php } ?>
                                                            
                                                             <?php if($login && $array['idU']==$_SESSION['id']){ ?>
                                                                    <button onclick="listdelt('<?php echo $presi['id'] ?>','<?php echo $array['id'] ?>','ac')" class="btn  btn-danger btn-sm" id="vote<?php echo $presi['id'] ?>" data-id="16051"> حذف من اللائحة</button>
                                                                    <?php } ?></div>
                                                        </div>
                                                    </div>
                                                </li>
                                            <?php }else{  $title; $title=titleinfo($cont['idT']);$rate_inf; $rate_inf=detailpost($title['id'],'dr') ; ?>
                                                <li id="mdl-<?php echo $title['id']; ?>" class="list-group-item">
                                                    <div class="row">
                                                        <div class="col-xs-2" style="float:right"> <a class="film-cover cover" href="post.php?id=<?php echo $cont['idT']; ?>"><img style="height:120px" class="img-responsive cover" src="process/<?php echo $title['image'] ?>" alt="<?php echo $title['title'] ?>"></a> </div>
                                                        <div class="col-xs-10 content">
                                                            <div class="row no-gutter">
                                                                
                                                                <div class="col-xs-2 text-center group-item-rating"> 
                                                                    
                                                                    <?php if($rate_inf['myR']=='true'){ ?>
                                                                    <i style="color:yellow" class="fa fa-star"></i> <?php echo  ($rate_inf['myRN']*2).'/10'; ?>
                                                                    <?php }else{ ?>
                                                                ...
                                                                <div class="col-xs-10">
                                                                    <h6 class="text-primary title">1. <a href="post.php?id=<?php echo $title['id'] ?>" title="<?php echo $title['title'] ?>" ><?php echo $title['title'] ?></a> 
                                                                        
                                                                    <?php if ($login){ ?>
                                                                    <button id='addTb<?php echo $title['id'] ?>' onclick="addT('<?php echo $title['id'] ?>','<?php echo $title['image'] ?>','<?php echo $title['title'] ?>','<?php echo substr($title['f_date'],6,9); ?>','<?php echo $title['content_type'] ?>','<?php echo $title['episodes'] ?>')" class="btn simple btn-manage-list" data-id="" data-stats=""><span>
                                                                    ...
                                                                    if($title['content_type']=='serie'){
                                                                        $stat=datasignif($title['country'],'countryF');
                                                                    }else{
                                                                        $stat=datasignif($title['country'],'countryM'); 
                                                                    }

                                                                    $type=datasignif($title['content_type'],'type');
                                                                    $title['p_date'] = substr($title['p_date'],6,9);

                                                                    $title['country'] = $type.' '.$stat;
                                                                    ?>
                                                                    <p class="text-muted"><?php echo $title['country']; ?> - <?php echo $title['p_date']; ?>, <?php if($title['episodes']!='' 
                                                                    && is_numeric($title['episodes'])){ echo $title['episodes'].' حلقة';}else{} ?></p>
                                                                    <div class="m-t">
                                                                    <?php if($login && $array['type']=='vote'){ ?>
                                                                ...
                                                                if($fs->num_rows=='0'){
                                                                ?>
                                                                <button onclick="votelist('<?php echo $title['id'] ?>','<?php echo $array['id'] ?>','dr')" class="btn btn-cast-vote btn-default btn-sm" id="vote<?php echo $title['id'] ?>" data-id="16051">إضافة صوت</button>
                                                                <?php }else{ ?>
                                                                <button id="vote<?php echo $title['id'] ?>" style="border:1px solid #d21818" onclick="votelist('<?php echo $title['id'] ?>','<?php echo $array['id'] ?>','dr')" class="btn btn-cast-vote btn-default btn-sm"  data-id="16051">الغاء الصوت</button>
                                                                <?php } ?>
                                                                
                                                                <span class="p-l-sm text-muted text-xs"><b id="votes<?php echo $title['id'] ?>"><?php echo $cont['score'] ?></b> نقطة</span>
                                                            
                                                            <?php } ?>
                                                                        
                                                                    <?php if($login && $array['idU']==$_SESSION['id']){ ?>
                                                                    <button onclick="listdelt('<?php echo $title['id'] ?>','<?php echo $array['id'] ?>','dr')" class="btn  btn-danger btn-sm" id="vote<?php echo $title['id'] ?>" data-id="16051"> حذف من اللائحة</button>
                                                                    <?php } ?>
                                                                    </div>
                                                                </div>
                        ...
                        <div id="cmtsapp" pid="232" ptype="actor" title="" class="box comments-box post-comments" style="min-height: 100px;">
                                ...
                                <div class="post-form-body">
                                    ...
                                    <div class="post-form-textarea">
                                        ...
                                        <div class="text-left post-form-footer">
                                            ...
                                            <button id="sendc" onclick="opertion('ls|comment','<?php echo $_GET['id']; ?>')" type="button" class="el-button btn white m-l-sm el-button--default el-button--mini">
                                                <!---->
                                                <!----><span>نشر</span></button>

                                            <button style="display:none" id="cancel_e" onclick="cancel_e('ac|comment','<?php echo $array['id']; ?>')" type="button" class="el-button btn white m-l-sm el-button--danger el-button--mini pull-right">
                                                <!---->
                            ...
                            <div class="box-body thread-post-form">
                                <ul id="comment-top" class="post-list">
                                    ...
                                    WHERE comments.idP=? AND comments.postT='ls' AND reports.idT='cm'  AND likes.postT='cm' GROUP BY comments.id ORDER BY comments.wn DESC 
                            ...
                            <div class="box-footer"><button id="more_cB" onclick="opertion('ac|more_c','<?php echo $array['id']; ?>')" type="button" class="el-button btn btn-block btn-default el-button--default"><span><strong id="more_cS">المزيد من التعليقات</strong></span></button></div>
                            <?php } ?>
                    ...
                    <div class="col-lg-4 col-md-4">
                        <div class="content-side">
                            ...
                            <div class="box custom-list-preview">
                                <div class="box-header b-b">
                                    <h2>لوائح <?php echo userinfo($array['idU'])['username'] ?></h2>
                                </div>
                                <?php 
                                            
                                        $stmtA = $conn->prepare("SELECT 
                                        ...
                                        *
                                        ...
                                        $array2['totalS']=$resultV->fetch_assoc()['total'];
                                            ...
                                            if( $array2['type']=='public' || $array2['type']=='vote'  || ($login && $array2['idU']==$_SESSION['id'] ) || !detailpost($array2['id'],'ls')['postrepo']>100 ){
                                            ...
                                            <div class="box-body">
                                                <div class="content people">
                                                    <ul class="collection">
                                                        ...
                                                        <?php if($array2['content']=='title'){ $typea="عنوان"; ?>
                                                        <li class="list-item people"><a href="list.php?id=<?php echo $array2['id']; ?>" title="<?php $tinf; $tinf=titleinfo($items['idT']); ?>">
                                                                <img style="height:100%" src="process/<?php echo $tinf['image']; ?>" alt="<?php echo $tinf['title']; ?>">
                                                            </a>
                                                        </li>
                                                        <?php }else{ $typea='شخص' ?>
                                                        <li class="list-item people"><a href="list.php?id=<?php echo $array2['id']; ?>" title="<?php $tinf; $tinf=personeinfo($items['idT']); ?>">
                            ...
                            <div id="sticky-wrapper" class="sticky-wrapper" style="height: 250px;">
                                <div class="sticky" style="width: 334px;">
                                    <div class="spnsr_right_2016">
                                        <div class="spnsr" id="mdl-gpt-fbox3-0" style="min-height: 250px;" data-google-query-id="CK_ynNav7ugCFcqeGwodxCQPjg">
                                            <script>
                                                mdltag.cmd.push(function() {
