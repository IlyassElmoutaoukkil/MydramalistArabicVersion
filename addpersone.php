...
<body>
    <?php include("menu.php"); addvisite('addpersone'); ?>
                        ...
                        <div class="col-lg-9 col-md-9">
                            <div class="box-body">
                                <div class="content" style="min-height: 300px;">
                                    <form id="addpersone" class="el-form edit-container">
                                        <input type="text" style="display:none" value="addtitle" name="addpersone">
                                        <script>
                                            $(document).keypress(
                                                function(event) {
                                                    if (event.which == '13') {
                                                            ...
                                                            <div class="el-form-item">
                                                                ...
                                                                <div class="el-form-item__content"><label><b>الاسم (بالأحرف اللاتينية)*</b></label>
                                                                    <div id="confirmed" class="el-input el-input--suffix _600 ">
                                                                        ...
                                                                        <input onkeyup="gettitle()" required type="text" name="title" autocomplete="off" placeholder="معروف ياسم" class="el-input__inner">
                                                    ...
                                                    <div class="row">
                                                        <div class="el-form-item col-lg-6">
                                                            ...
                                                            <div class="el-form-item__content"><label><b>الاسم الشخصي</b></label>
                                                                <div class="el-input">
                                                                    <!----><input required name="fname" type="text" autocomplete="off" placeholder="الاسم الشخصي" class="el-input__inner">
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                        ...
                                                        <div class="el-form-item col-lg-6">
                                                            ...
                                                            <div class="el-form-item__content"><label><b>الاسم العائلي</b></label>
                                                                <div class="el-input">
                                                                    <!----><input required name="lname" type="text" autocomplete="off" placeholder="الاسم العائلي" class="el-input__inner">
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                    ...
                                                    <div class="row">
                                                        <div class="el-form-item col-lg-6">
                                                            ...
                                                            <div class="el-form-item__content"><label><b>الاسم الكامل بلغة بلده</b></label>
                                                                <div class="el-input">
                                                                    <!----><input required name="orname" type="text" autocomplete="off" placeholder="الاسم الكامل بلغة بلده" class="el-input__inner">
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                                    <!---->
                                                    ...
                                                    <div class="form-group">
                                                        <div><label><b>أسماء أخرى يعرف بها العمل ايضا</b></label>
                                                            <div class="mdl-input-tag-wrapper">
                                                                ...
                                                                <input placeholder="مثال: Gaksital; Bridal Mask; Doll Mask" data-role="tagsinput" name="othname" type="text" class="new-tag"></div>
                                                        </div> <small class="text-muted">أسماء أخرى يشتهر بها هدا الممثل .</small>
                                                    </div>

                                                    <div class="form-group"><label><b>سيرة</b></label>
                                                        <div class="el-textarea"><textarea name="biography" autocomplete="off" placeholder="ملخص السيرة الداتية" class="el-textarea__inner" style="min-height: 117px; height: 117px;"></textarea>
                                                            <!---->
                                                                ...
                                                                <div class="row release-date">
                                                                    <div class="col-lg-12">
                                                                        <div class="el-select">
                                                                            <!---->
                                                                            <div class="el-input el-input--suffix">
                                                                                <!----><input data-provide="datepicker" name="dayd" type="text" readonly="readonly" autocomplete="off" placeholder="" class="el-input__inner">
                                                                                <!----><span class="el-input__suffix"><span class="el-input__suffix-inner"><i class="el-select__caret el-input__icon el-icon-arrow-up"></i>
                                                                                        <!---->
                                                                                        <!---->
                                                                                        <!---->
                                                                ...
                                                                <div class="row release-date">
                                                                    <div class="col-lg-12">
                                                                        <div class="el-select">
                                                                            <!---->
                                                                            <div class="el-input el-input--suffix">
                                                                                <!----><input data-provide="datepicker" name="dayb" type="text" readonly="readonly" autocomplete="off" placeholder="" class="el-input__inner">
                                                                                <!----><span class="el-input__suffix"><span class="el-input__suffix-inner"><i class="el-select__caret el-input__icon el-icon-arrow-up"></i>
                                                                                        <!---->
                                                                                        <!---->
                                                                                        <!---->
                                                        ...
                                                        <div class="col-lg-6">
                                                            <div class="clear form-group">
                                                                <div id="showcover">
                                                                    ...
                                                                    <div class="edit-cover"><span class="no-cover"></span></div>
