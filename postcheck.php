...
<head>
    <title><?php echo 'تفقد العمل '.$titleinfos['title']; ?></title>
                ...
                ?>
                                ...
                                <div class="row"><?php $titledetail; $titledetail=detailpost($titleinfos['id'],'dr'); ?>
                                    ...
                                    <div id="show-detailsxx" class="col-sm-8">
                                        ...
                                        <div class="show-synopsis">
                                            ...
                                            <p><?php if($titleinfos['p_date']==''){ echo 'لم يتم إضافته';}else{ echo $titleinfos['p_date']; } ?></p>
                                        </div>
                                        
                                        <div class="show-synopsis">
                                            <b class="inline">تاريخ الانتهاء</b>
                                            <p><?php if($titleinfos['f_date']==''){ echo 'لم يتم إضافته';}else{ echo $titleinfos['f_date']; } ?></p>
                                        </div>
                                        
                                        <div class="show-synopsis">
                                            <b class="inline">المشاركة من</b>
                                            <p><a href="profile.php?id=<?php echo $titleinfos['auther_id'] ?>" >
                                                <img style="width:30px; height:30px;margin-left: 10px" src="process/<?php echo userinfo($titleinfos['auther_id'])['picture']; ?>">  <?php echo userinfo($titleinfos['auther_id'])['username']; ?>
                                               </a>
                                            </p>
                                        </div>
                        ...
                        <div class="box clear" id="castD">
                            ...
                            <?php
                                                    ...
                                                    $stmtA = $conn->prepare("SELECT work.idP, work.idT, work.id, work.chara, work.type, work.format ,persones.fname, persones.lname, persones.id, persones.picture FROM work JOIN persones ON persones.id=work.idP WHERE idT=? AND type='act'");
                                                    $stmtA->bind_param("s", $titleinfos['id']);
                                                    $stmtA->execute();
                                                    $resultA=$stmtA->get_result();                                     
