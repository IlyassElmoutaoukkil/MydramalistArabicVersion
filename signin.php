                            ...
                            <div class="box-body padding">
                                <div class="row">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="row">
                                            <div class="col-lg-offset-1 col-lg-10">
                                                ...
                                                <a href="signup.php" class="btn white">سجل الان</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-6 b-l">
                                        <div class="row">
                                            <div class="col-lg-offset-1 col-lg-10">
                                                <h5 class="m-b-md">تسجيل الدخول</h5>
                                                ...
                                                <form method="post" id="loginform">
                                                    ...
                                                    <div class="form-group"> <label>كلمة السر</label> <input type="password" name="password" class="form-control" placeholder="كلمة السر" required>
                                                        <input type="text" style="display:none;" name="login" value="login">
                                                    </div>
                                                    <div class="checkbox"> <label class="md-check"><input type="checkbox"><i></i>تذكرني</label> </div>
                                                    <div class="p-t m-b-xs">
                                                        <div class="row">

                                                            <div class="col-md-6"> <a href="forgetpass.php" class="btn btn-lg text-primary">نسيت كلمة السر؟</a> </div>

                                                            <div class="col-md-6"> <input type="hidden" name="g-recaptcha-response" /> <button type="submit" class="btn btn-block btn-lg primary text-u-c">دخول</button> </div>
