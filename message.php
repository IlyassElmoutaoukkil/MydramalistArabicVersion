...
<body>
    <?php include("menu.php");addvisite('message'); ?>
            ...
            <div id="content" class="slideout-panel slideout-panel-right">
                <div class="app-body">
                    ...
                    <div id="pm" class="container-fluid">
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="box pm-menu">



                                    <ul class="row no-gutter list ">

                                        <li class="col-xs-12 col-lg-12 nav-item pull-right" style="list-style: none;position: relative;float: right;margin: 12px 1px;">

                                            <button onclick="messta('send')" style="width:99%" type="button" class="el-button btn-compose el-button--default">
                                                <span>رسالة جديدة</span></button>

                                        </li>
                                        <li class="col-xs-6 col-lg-12 list-item active router-link-active nav-item">
                                            <a onclick="messta('inbox')"  type="button"> الواردة <span class="max-inbox"><?php
                                    ...
                                    ?></span> </a>
                                        ...
                                        <li class="col-xs-6 col-lg-12 list-item nav-item">
                                            <a href="#outbox" onclick="messta('outbox')"  type="button">الصادرة <span class="max-inbox"><?php
                            ...
                            <div class="col-lg-9 tab-content">
                                ...
                                <div id="send" class="box " role="">
                                    <div class="box-header">
                                        <h1>رسالة جديدة</h1>
                                    </div>
                                    <div class="box-body">
                                        <div class="section with-header main">
                                            <form id="compose-form" method="POST">
                                                <div class="form-group">
                                                    <div aria-haspopup="listbox" role="combobox" aria-owns="el-autocomplete-1269" class="el-autocomplete" style="display: block;">
                                                        <div class="el-input el-input--suffix">
                                                            <!---->
                                                            <input style="display:none" required type="password" value="send" name="mssg">

                                                            <input required id="user" name="username" type="text" autocomplete="off" valuekey="value" placeholder="أضف اسم المستخدم" triggeronfocus="true" placement="bottom-start" class="el-input__inner" role="textbox" aria-autocomplete="list" aria-controls="id" aria-activedescendant="el-autocomplete-1269-item--1">
                                                        ...
                                                        <div role="region" id="names" class="el-autocomplete-suggestion el-popper" style="display: none;">
                                                            <div class="el-scrollbar">
                                                                <div class="el-autocomplete-suggestion__wrap el-scrollbar__wrap" style="margin-bottom: -17px; margin-right: -17px;overflow:hidden">
                                                                    <ul id="listu" class="el-scrollbar__view el-autocomplete-suggestion__list" role="listbox" id="el-autocomplete-1269" style='padding-bottom: 15px;'>
                                                                        <p id="error" style="display:none" class="el-select-dropdown__empty" style="margin: 15px 15px 15px 0px;">أسف، لكن لا يوجد اي مستعمل بهدا الاسم.</p>
                                                ...
                                                <div class="form-group">
                                                    <div class="el-input">
                                                        <!---->
                                                        <input required name="sub" type="text" autocomplete="off" placeholder="الموضوع" class="el-input__inner">
                                                        <!---->
                                                        <!---->
                                                        <!---->
                                                    </div>
                                                ...
                                                <div class="form-group">
                                                    <div class="el-textarea">
                                                        <textarea name="text" required placeholder="أضف رسالتك" class="el-textarea__inner" style="min-height: 117px; height: 117px;"></textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <button type="submit" class="el-button el-button--primary is-plain">
                                                        <!---->
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                    ...
                                                    <td>
                                                        <a data-toggle="tab" href="#messages" aria-controls="messages" role="tab" aria-selected="true" onclick="messageread('<?php echo $useri['code']; ?>')" class=""><span style="cursor:pointer" class="subject text-primary"><b><?php if($sessions1['sub']=='') {echo ' - بدون موضوع - ';}else{echo $sessions1['sub'];} ?></b></span></a> <span class="author"><?php echo $useri['username']; ?></span> <span class="text-muted">
                                    ...
                                    ?>
                                        ...
                                        ?>
                                            ...
                                            ?>
                                                    ...
                                                    <td><a onclick="messageread('<?php echo $user['code']; ?>')" data-toggle="tab" href="#messages" aria-controls="messages" role="tab" aria-selected="true" class=""><span  style="cursor:pointer" class="subject text-primary"><b><?php if($sessions['sub']=='') {echo ' - بدون موضوع - ';}else{echo $sessions['sub'];} ?></b></span></a> <span class="author"><?php echo $user['username']; ?></span> <span class="text-muted">
                                ...
                                <div class="box " role="" id="messages" style="min-height: 300px;">
    ...
    <script type="application/javascript">
     ...
     <?php if(isset($_GET['id'])){
                                        $stmtA1 = $conn->prepare("SELECT * FROM users WHERE code=? ");
                                        $stmtA1->bind_param("s",$_GET['id']);
                                        $stmtA1->execute();
                                        $resultA1=$stmtA1->get_result();
                                        $re=$resultA1->num_rows;
                                        ...
                                        <?php }else{ ?>
                                            <script>
                                messageread('<?php echo $_GET['id']; ?>')</script>
