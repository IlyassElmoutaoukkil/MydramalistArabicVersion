                        ...
                        <div id="collection-lists" class="content-main">
                            <div class="box">
                                <div class="box-header m-t-sm">
                                    <h1 class="text-xl text-center" style="color:#454b54; font-size:50px;margin-bottom:0px;">خطأ في العنوان</h1>
                                    
                                </div>
                                <div class="box-body text-center" style="padding: 1.1rem 1rem;">
                                    <img src="error.png" style="margin-bottom:0px;" >
                                   <p style="font-size:35px;padding-top:0px;margin-top:0px;">تم حذف العنوان او تم تغييره.</p>
                                </div>
                            </div>
                        </div>
