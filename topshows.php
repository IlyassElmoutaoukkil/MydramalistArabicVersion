...
<body>
    <?php include("menu.php");addvisite('topshows'); ?>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8">
                        <?php
                            $stmtF = $conn->prepare("SELECT * FROM title WHERE admin_o='1' ");
                            $stmtF->execute();
                                ...
                                $title='أعلى الدرامات إعجابا ';
                                    ...
                                    if($_GET['option']=='famous'){
                                        ...
                                        $title=' الدرامات المضافة حديثا ';
                                         ...
                                         $title=' الدرامات القادمة حديثا ';
                                         $stmtu = $conn->prepare("SELECT *  FROM title WHERE status='notpub' AND admin_o='1' ORDER BY wn DESC LIMIT 10 OFFSET ?"); //WHERE RATE>7 LIMIT 10 STATUS 1
                                         $stmtu->bind_param('i',$offset);
                                    }
                                }
                                $stmtu->execute();
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        <div class="col-xs-9 row-cell content">
                                            ...
                                            <p>
                                                <span class="read_only" data-rating="<?php echo $titledetail['postRa']; ?>"></span>
                                                <span class="p-l-xs score"><?php echo substr($titledetail['postRa']*2,0,3); ?></span>
                                            </p>
